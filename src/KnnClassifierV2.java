...
public class KnnClassifierV2 {
    ...
    public static ArrayList<Flower> preProcessorUnitTest() throws Exception {
        KnnClassifierV2 knnClassifier = new KnnClassifierV2();

        String testString = "5.1,3.5,1.4,0.2,Iris-setosa\n4.9,3.0,1.4,0.2,Iris-setosa\n";
        InputStream is = new ByteArrayInputStream(testString.getBytes());
        ArrayList<Flower> data = knnClassifier.preProcessData(is);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<Flower> data = knnClassifier.preProcessData(new FileInputStream(file));
    ...
    private ArrayList<Flower> preProcessData(InputStream in) {
